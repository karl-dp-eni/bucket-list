...
#[ORM\UniqueConstraint(name: 'UNIQ_IDENTIFIER_USER', fields: ['username', 'email'])]
#[UniqueEntity(fields: ['username', 'email'], message: 'There is already an account with this username and/or email')]
